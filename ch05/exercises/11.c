/*
 * The following table shows telephone area codes in the state of Georgia along with the
 ...
 * recognized". Use the techniques discussed in Section 5.3 to make the switch
